 ...
 * RESCUED WSCLient depends on the WSCLient module, download and install it from:
   https://drupal.org/project/wsclient
 * This module is intended to work with the RESCUED module, download and install it from:
   TODO: https://drupal.org/sandbox/bendiy/1804762
 * Copy the whole rescued_wsclient directory to your modules directory
   (e.g. DRUPAL_ROOT/sites/all/modules) and activate the RESCUED WSCLient module
